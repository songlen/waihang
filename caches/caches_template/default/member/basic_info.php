                ...
                <form class="layui-form" action="?m=member" method="post">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="info[surname]" value="<?php echo $basicinfo['surname'];?>" lay-verify="required" autocomplete="off" placeholder="姓" class="layui-input">
                        </div>
                        <div class="layui-input-inline">
                            <input type="text" name="info[surname_spell]" value="<?php echo $basicinfo['surname_spell'];?>" lay-verify="required" autocomplete="off" placeholder="姓拼音" class="layui-input">
                        </div>
                    </div>
                    <div class="layui-form-item">
