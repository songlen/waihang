...
<div class="pad-lr-10">
	<div class="zh_en">
		<a href="?m=train&c=order&a=userResume&member_id=<?php echo $member_id;?>">中文简历</a>
		<!-- <a target="_blank" href="?m=train&c=order&a=userResume&member_language=en&id=<?php echo $member_id;?>&resume=1">预览简历</a> -->
	</div>
