...
class enroll extends admin {
	...
	public function export($where = '', $language='zh'){
		...
		// $csvcontent = "简历已审,允许面试,报名号,面试地点,报名时间,英文名,姓拼音,名拼音,民族,工作年限,政治面貌,年龄,身高,体重,护照有效期,姓名,游泳能力,身上是否有疤痕及纹身,何时可开始工作,性别,毕业日期,身份证号,护照号码,手机,国内座机,邮箱,档案存放地,出生日期,现居住城市,简历批注,父亲姓名,父亲电话,母亲姓名,母亲电话,婚姻状况,配偶姓名（未婚不填）,配偶电话（未婚不填）,户口地址,通讯编码,最高学历、学位,专业,毕业院校,国外住址,国外电话,备注";
