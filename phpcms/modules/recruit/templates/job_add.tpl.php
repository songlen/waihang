...
<form action="?m=recruit&c=job&a=add" method="post" name="myform" id="myform">
	<table cellpadding="2" cellspacing="1" class="table_form" width="100%">
		...
		<tr>
			...
			<td><input type="text" name="info[job_name]" id="job_name" size="30" class="input-text"></td>
		</tr>
		
		<tr>
			<th width="100">招聘人数：</th>
			<td><input type="text" name="info[people_num]" id="people_num" size="30" class="input-text"></td>
		</tr>
		
		<tr>
			<th width="100">工作经验：</th>
			<td><input type="text" name="info[work_experience]" id="work_experience" size="30" class="input-text"></td>
		</tr>
		
		<tr>
			<th width="100">工资待遇：</th>
			<td><input type="text" name="info[salary]" id="salary" size="30" class="input-text"></td>
		</tr>
		
		<tr>
			<th width="100">工作地点：</th>
			<td><input type="text" name="info[location]" id="location" size="30" class="input-text"></td>
		</tr>
