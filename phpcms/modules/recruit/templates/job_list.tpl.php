...
<div class="pad-10">
	...
	<div class="content-menu ib-a blue line-x">
		<a class="add fb" href="javascript:;" onclick="javascript:window.top.art.dialog({id:'add',iframe:'?m=recruit&c=job&a=add&enterprise_id=<?php echo $_GET["enterprise_id"];?>&enterprise_name=<?php echo $_GET["enterprise_name"];?>', title:'<?php echo l('job_add');?>', width:'800', height:'450'}, function(){var d = window.top.art.dialog({id:'add'}).data.iframe;var form = d.document.getElementById('dosubmit');form.click();return false;}, function(){window.top.art.dialog({id:'add'}).close()});void(0);"><em><?php echo l('job_add');?></em></a> <span></span>
	...
	<table width="100%" cellspacing="0">
		<thead>
			<tr>
				...
				<th width="3%">ID</th>
				<th width="30%" align="center"><?php echo L('job_name')?></th>
	...
	?>
		<tr>
			...
			<td align="center" width="30%"><?php echo $info['job_name']?></td>
