...
?>   
	...
	<td align="center">
	<!-- <a href="?m=poster&c=space&a=public_preview&spaceid=<?php echo $info['spaceid']?>" target="_blank"><?php echo L('preview')?></a> | <a href="javascript:call(<?php echo $info['spaceid']?>);void(0);"><?php echo L('get_code')?></a> |  --><a href='?m=poster&c=poster&a=init&spaceid=<?php echo $info['spaceid']?>&menuid=<?php echo input('menuid')?>' ><?php echo L('ad_list')?></a> | 
	...
	| <a href="index.php?m=poster&c=poster&a=add&spaceid=<?php echo $info['spaceid']?>&menuid=<?php echo input('menuid')?>&pc_hash=<?php echo $_SESSION['pc_hash']?>">添加图片</a>
	</td>
	</tr>
<?php 
	}
