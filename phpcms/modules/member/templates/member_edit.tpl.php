...
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			<td width="80">是否员工</td> 
			<td>
				<input type="radio" name="info[is_working]" value="1" <?php if($memberinfo['is_working'] == '1') echo 'checked';?>> 是
				<input type="radio" name="info[is_working]" value="0" <?php if($memberinfo['is_working'] == '0') echo 'checked';?>> 否
			</td>
		</tr>
	</table>
</fieldset>
